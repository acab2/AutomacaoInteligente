%Seguir Tutorial: http://emanual.robotis.com/docs/en/software/dynamixel/dynamixel_sdk/library_setup/matlab_windows/#matlab-windows
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
ESC_CHARACTER               = 'c';          % Key for escaping loop
...
%Preciso da garra para ver funcionamento
while 1
    if input('Press any key to continue! (or input c to quit!)\n', 's') == ESC_CHARACTER
        break;
    end
